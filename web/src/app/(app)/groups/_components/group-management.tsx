...
export function GroupManagement({ 
  ...
  async function onAdd(profileId: string) {
    try {
      await addResearcherToDepartment(profileId, department);
    ...
    <div className="grid gap-6 lg:grid-cols-2">
      <Card>
        <CardHeader>
          ...
          <CardDescription>Pesquisadores vinculados a {department}</CardDescription>
        </CardHeader>
        <CardContent>
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Busque pesquisadores para vincular ao seu departamento</CardDescription>
        </CardHeader>
