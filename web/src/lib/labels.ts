...
export const labels = {
  ...
  roles: {
    ...
    dept_manager: "Gerente de Grupo",
    cp_manager: "Gerente do CP",
    maua_manager: "Gerente Mauá",
  },
  department: {
    name: "Nome",
    description: "Descrição",
    none: "Nenhum grupo vinculado",
    members: "Pesquisadores",
  ...
  submission: {
    ...
    agency: "Agência de fomento",
    modality: "Modalidade",
    knowledgeArea: "Área de conhecimento",
    department: "Grupo",
    unit: "Unidade",
    researchDuration: "Tempo de pesquisa",
    partners: "Parceiros",
    members: "Equipe envolvida (Pesquisadores cadastrados)",
    status: "Situação interna",
    agencyStatus: "Situação na agência",
    feedback: "Parecer/Feedback",
  ...
  submissionStatus: {
    draft: "Rascunho",
    submitted: "Aguardando Departamento",
    approved_dept: "Aguardando CP",
    approved_cp: "Aguardando Mauá",
    approved_maua: "Aprovado (Interno)",
    rejected: "Não aprovado",
  },
  agencyProjectStatus: {
    em_analise: "Em análise",
    pendente: "Pendente (Documentação)",
    aprovado: "Aprovado (Aguardando contrato)",
